 ...
 *  Runs in O(E + V) time.
 *
 *  C:\> algscmd TarjanSCC tinyDG.txt
 *  5 components
 *  1 
 *  0 2 3 4 5
 *  9 10 11 12
...
{
  /// <summary><para>
  /// The <c>TarjanSCC</c> class represents a data type for
  ...
  /// <seealso cref="KosarajuSharirSCC"/> and <seealso cref="GabowSCC"/>.
  /// </para></summary>
  /// <remarks><para>For additional documentation,
  /// see <a href="http://algs4.cs.princeton.edu/42digraph">Section 4.2</a> of
  /// <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.</para>
  /// <para>This class is a C# port from the original Java class 
  /// <a href="http://algs4.cs.princeton.edu/code/edu/princeton/cs/algs4/TarjanSCC.java.html">TarjanSCC</a>
  ...
  public class TarjanSCC
  {
    ...
    /// <summary>
    /// Demo test the <c>TarjanSCC</c> data type.</summary>
    /// <param name="args">Place holder for user arguments</param>
    /// 
    [HelpText("algscmd TarjanSCC tinyDG.txt", "File with the pre-defined format for directed graph")]
