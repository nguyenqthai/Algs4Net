/******************************************************************************
 *  File name :  BinarySearchSTTests.cs
 *  Purpose   :  Contains basic unit tests for the BinarySearchST class
 *
 ******************************************************************************/
using Algs4Net;
using System;
...
namespace Algs4NetUnitTests
{
  ...
  public class BinarySearchSTTests
  {
    ...
    public void BinarySearchSTTest1()
    {
    ...
    [TestMethod]
    [ExpectedException(typeof(NullReferenceException))]
    public void BinarySearchSTTest2()
    {
      // testing indexer semantics
      BinarySearchST<int, string> st = new BinarySearchST<int, string>();
      st[99] = null;
      ...
      BinarySearchST<int, int> st2 = new BinarySearchST<int, int>();
      st2[3] = 22;
      st2[2] = 33;
      st2[99] = 44;
      st2[2] = 55;
    ...
    [TestMethod]
    public void BinarySearchSTTest3()
    {
      Alphabet alpha = Alphabet.LowerCase; // ab..z
      Random rnd = new Random();
      BinarySearchST<int, char> bst = new BinarySearchST<int, char>();
      int[] keys = new int[32];
      for (int i = 0; i < keys.Length; i++)
      {
        keys[i] = i * 2;
