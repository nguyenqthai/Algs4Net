/******************************************************************************
 *  File name :  LinkedStackTests.cs
 *  Purpose   :  Contains basic unit tests for the LinkedStack class
 *
 ******************************************************************************/
using Algs4Net;
using System.Text;
...
namespace Algs4NetUnitTests
{
  ...
  {
    private string IteratorToString(LinkedStack<int> input)
    {
